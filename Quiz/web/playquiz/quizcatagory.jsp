        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="text-center col-lg-10" style="margin: 40px 0px;">
                    <select class="form-control" required="required" name="cat" id="select">
                        <option disabled="disabled" selected="selected">Select Topic</option>
                        <c:forEach items="${catList}" var="topic">
                            <option value="${topic.catagory}">${topic.catagory}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="col-lg-1"></div>
            ...
            <div class="form-group">
                <div class="col-lg-10 col-lg-offset-5">
                    ...
                    <input type="hidden" name="pageRequest" value="play">
                </div>
            </div>
        </fieldset>
    </form>
